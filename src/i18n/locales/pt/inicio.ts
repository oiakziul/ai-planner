export const inicioPT = () => ({
  ...
  goalName_title: "Nome da meta",
  goalName_question: "Qual o objetivo que você deseja alcançar?",
  goalName_placeholder: "ex: Viagem para o Japão",

  // Passo 5: Custo da Meta
  goalAmount_title: "Custo da meta",
  goalAmount_question: "Quanto custa realizar esse sonho?",
