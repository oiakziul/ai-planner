  ...
  ({ children, className, nome, icon: Icon, ...props }, ref) => {
    return (
      ...
      >
        ...
        {/* [CORRIGIDO]: Seta direita e círculo reduzidos e mais delicados (h-5 w-5 e Arrow h-3 w-3) */}
        <div className="absolute right-3 flex h-5 w-5 translate-x-12 items-center justify-center rounded-full bg-primary text-primary-foreground opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
